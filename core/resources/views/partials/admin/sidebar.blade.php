<div class="col-md-2">
    <div class="list-group">
        ...
        <a href="{{ route('admin-files') }}" class="list-group-item list-group-item-action @if(isset($activeMenu) && $activeMenu == 'files') active @endif">{{ lang('lang.sell_file') }} <span class="badge badge-danger float-left">جدید</span></a>
