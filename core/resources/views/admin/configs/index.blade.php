...
@section('page-title'){{ __('lang.configs') }}@endsection

@section('content')
    <div class="card">
        <div class="card-header">{{ __('lang.configs') }}</div>
        <div class="card-body">
            <div class="row">
    ...
    <div class="row mt-3">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">{{ __('lang.scripts') }}</div>
                <div class="card-body">
                    <form method="post" action="{{ route('admin.configs.scripts') }}">
                        ...
                        <button type="submit" class="btn btn-primary mt-2">{{ __('lang.save') }}</button>
                    </form>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">{{ __('lang.styles') }}</div>
                <div class="card-body">
