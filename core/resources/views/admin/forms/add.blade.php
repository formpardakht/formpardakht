...
@section('page-title'){{ __('lang.add_new_form') }}@endsection

@section('content')
  <div class="card">
    <div class="card-header">
      {{ __('lang.add_new_form') }}
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-md-6 offset-md-3">
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="txt-amount" name="amount" value="{{ old('amount') }}" placeholder="{{ __('lang.to_optional_amount_leave_empty') }}">
            </div>
