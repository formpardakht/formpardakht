...
@section('page-title'){{ __('lang.edit_factor') }}@endsection
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="txt-title" class="label">{{ __('lang.tax') }} ({{ __('lang.required') }})</label>
              <input type="number" class="form-control col-md-6" id="txt-tax" name="tax" value="{{ $factor->tax }}">
            </div>
            <div class="form-group">
              <label class="label">{{ __('lang.items') }} ({{ __('lang.required') }})</label>
              <a href="javascript:" class="float-left" onclick="addNewField()">{{ __('lang.add_new_item') }}</a>
              <div id="items">
            ...
            <div class="form-group">
              <button class="btn btn-primary">{{ __('lang.edit') }}</button>
            </div>
          </form>
        </div>
      </div>
