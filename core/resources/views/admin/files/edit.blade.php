...
@section('page-title'){{ __('lang.edit_file') }}@endsection
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div id="advanced">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="txt-pay-limit" name="pay_limit" value="{{ $file->pay_limit }}" placeholder="{{ __('lang.to_unlimited_payment_leave_empty') }}">
              </div>
              <div class="form-group">
