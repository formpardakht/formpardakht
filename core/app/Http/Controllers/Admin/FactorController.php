...
class FactorController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        return redirect()->back()
            ->with('alert', 'danger')
            ->with('message', __('lang.factor_min_items'));
    }
    ...
    public function showEdit(Request $request, $id)
    {
        ...
        return view('admin.factors.edit')
            ->with('activeMenu', 'factors')
            ->with('factor', $factor);
    }
        ...
        try {
            return DB::transaction(function () use ($request, $id) {
                ...
                return redirect()->route('admin-factors')
                    ->with('alert', 'success')
                    ->with('message', __('lang.changes_saved'));
            });
        } catch (\Exception $e) {
            return handle_exception($e);
        }
    ...
    public function delete(Request $request, $id)
    {
        if (app('site_configs')['APP_ENV'] === 'demo') {
            return redirect()->back()
                ->with('alert', 'warning')
                ->with('message', __('lang.demo_mode'));
        }
        ...
        if ($factor->default) {
            return redirect()->back()
                ->with('alert', 'danger')
                ->with('message', __('lang.cannot_delete_default_factor'));
        }
